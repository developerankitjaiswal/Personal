...
@section('content')
    <div id="content" class="app-content">
        <div class="d-flex align-items-center mb-3">
            <div>
                <h1 class="page-header mb-0">Create Brand</h1>
                <ol class="breadcrumb">
            ...
            <div class="ms-auto">
                <a href="{{ route('brand.index') }}" class="btn btn-primary rounded-2 px-4"><i
                        class="fa fa-list fa-lg me-2 ms-n2 text-success-900"></i>MANAGE BRAND</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <form action="{{ route('brand.store') }}" method="POST" enctype="multipart/form-data" id="categoryForm">
                    @csrf
                    <div class="card border-0 mb-4">
                        <div class="card-header h6 mb-0 bg-none p-3">
                            <i class="fa fa-list fa-lg fa-fw text-dark text-opacity-50 me-1"></i>Create Brand
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="image">Brand Thumbnail <span class="form-text">(optional)</span></label>
